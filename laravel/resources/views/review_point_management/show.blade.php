...
{{ Tag::formOpen('route' => ['review_point_management.update', $referral_bonus['id']], ['method' => 'PUT', 'class' => 'LockForm']) }}
    <fieldset>
        <legend>配布ポイント編集</legend>
        ...
        <div class="form-group">
            ...
            {{ Tag::formText('point', old('reward_condition_point', $referral_bonus['point'] ?? ''), ['class' => 'form-control', 'id' => 'rc_point']) }}<br />
        </div>
        <div class="form-group">
