...
@section('title', 'Dポイント管理')

@section('menu')
@include('partials.menu.point_exchange_menu', ['currentRoute' => 'd_point.index'])
@endsection

@php
$exchange_status_map = config('d_point.status');
@endphp
@section('menu.extra')
<div class="panel-heading">Search</div>
{{ Tag::formOpen(['url' => route('d_point.index'), 'method' => 'get']) }}
@csrf
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
    ...
    @empty
    <tr><td colspan="7">Dポイント込申し込みは存在しません</td></tr>
    @endforelse
</table>
