...
@section('title', 'デジタルギフトPayPal 管理')

@section('menu')
@include('partials.menu.point_exchange_menu', ['currentRoute' => 'digital_gift_paypal.index'])
@endsection
...
{{ Tag::formOpen(['url' => route('digital_gift_paypal.index'), 'method' => 'get']) }}
@csrf    
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
    ...
    <tr>
        <td rowspan="2" class="actions" style="white-space:nowrap">
            ...
            {{ Tag::formOpen(['url' => route('digital_gift_paypal.resend', ['exchange_request' => $exchange_request->id])]) }}
            @csrf    
    ...
    @empty
    <tr><td colspan="8">デジタルギフトPayPal申し込みは存在しません</td></tr>
    @endforelse
</table>
