...
@section('title', 'LINE Pay管理')

@section('menu')
@include('partials.menu.point_exchange_menu', ['currentRoute' => 'line_pay.index'])
@endsection

@php
$exchange_status_map = config('line_pay.status');
@endphp
@section('menu.extra')
<div class="panel-heading">Search</div>
{{ Tag::formOpen(['url' => route('line_pay.index'), 'method' => 'get']) }}
@csrf
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
    ...
    @empty
    <tr><td colspan="7">LINE Pay込申し込みは存在しません</td></tr>
    @endforelse
</table>
