    ...
    <div class="row content">
        ...
        <div class="col-md-3">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <input class="form-control js-datepicker" id="start_at" name="start_at" type="text"
        ...
        <div class="col-md-3">
            ...
            <div>
                <div class="row">
                    <div class="col-md-1" style="margin-top: 4px;">
                        {{ Tag::image(url('image/calendar.png'), 'img', ['id' => 'openCalendarEndDate', 'width' => '25px']) }}
                    </div>
                    <div class="col-md-11">
                        <input class="form-control js-datepicker" id="end_at" name="end_at" type="text"
        ...
        <div class="col-md-3">
            <div>
                <input type="hidden" name="user_promotion_id" value="1103874513">
                <div class="form-group">
                    {{ Tag::formSubmit('ダウンロード', ['id' => 'btn_export', 'class' => 'btn btn-export-user']) }}</div>
            </div>
        </div>
    </div>
    {{ Tag::formClose() }}
